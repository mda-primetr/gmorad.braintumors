...
load("data/processed_data/16S/physeq_filt_1.RData")

# Load after second filter ---
load("data/processed_data/16S/physeq_filt_2.RData")

# Load after third filter ---
load("data/processed_data/16S/physeq_filt_3.RData")
...
ggsave("output/figures/16S/alluvial_plot_to_show_filter_step.pdf", width = 17, height = 10, dpi = 300)
