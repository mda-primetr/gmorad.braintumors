...
save(physeq_negative_controls, file = "data/processed_data/16S/physeq_negative_controls.RData")
...
save(physeq_samples, file = "data/processed_data/16S/physeq_samples.RData")
...
ggsave("output/figures/16S/prop_cutoff_asv.pdf", width = 10, height = 10, dpi = 300)
...
ggsave("output/figures/16S/prop_cutoff_asv_zoomed.pdf", width = 10, height = 10, dpi = 300)
...
ggsave("output/figures/16S/prevalence_cutoff_genus_level.pdf", width = 10, height = 10, dpi = 300)
...
data.frame(
    ...
    write_csv("data/processed_data/16S/otu_cutoffs.csv")
