...
load("data/raw_data/16S/physeq_16S_tumor.RData")
load("data/processed_data/16S/physeq_negative_controls.RData")
load("data/processed_data/16S/physeq_samples.RData")
...
df_filt <- read_csv("data/processed_data/16S/otu_cutoffs.csv")
...
save(physeq_filt_1, file = "data/processed_data/16S/physeq_filt_1.RData")
...
# Export filtered phyloseq object ----
save(physeq_filt_2, file = "data/processed_data/16S/physeq_filt_2.RData")
...
# Export filtered phyloseq object ----
save(physeq_filt_3, file = "data/processed_data/16S/physeq_filt_3.RData")
...
save(physeq_all_scrubbed, file = "data/processed_data/16S/physeq_all_scrubbed.RData")
...
save(physeq_scrubbed_plus_nc_rem, file = "data/processed_data/16S/physeq_scrubbed_plus_nc_rem.RData")
...
load("data/processed_data/16S/physeq_all_scrubbed.RData")
physeq_all_scrubbed %>%
    speedyseq::tax_glom(taxrank = "Genus") %>%
    psmelt() %>%
    filter(Abundance > 0) %>%
...
save(genera_colors, file = "data/processed_data/16S/genera_colors.RData")
...
save(physeq_all_filt, file = "data/processed_data/16S/physeq_all_filt.RData")
