...
save(modules, file = "Processed_data/BrM/BrM_Modules.RData")
save(BrM_RNAData, file = "Processed_data/BrM/BrM_RNAData_raw.RData")
save(BrM_ProteinData, file = "Processed_data/BrM/BrM_ProteinData_raw.RData")
